-- Overrides other player_default.lua file.

AddCSLuaFile()

local PLAYER = {}

PLAYER.DisplayName			= "Admin Class"
...
PLAYER.MaxHealth			= 10000		-- Max health we can have
PLAYER.StartHealth			= 10000		-- How much health we start with
PLAYER.StartArmor			= 10000		-- How much armour we start with
...
function PLAYER:Spawn()
	if self.Player then
		PrintMessage( HUD_PRINTTALK, "Admin "..self.Player:GetName().. " just became a whole lot more powerful." )
	end
end
